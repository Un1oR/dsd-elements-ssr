---
name: html
description: Use when writing or reviewing HTML/CSS—build clean, semantic, accessible, responsive, cross-browser, SEO-friendly UI with a focus on usability, mobile support, performance, and clear markup/style organization.
---
